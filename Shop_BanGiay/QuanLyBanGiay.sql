...
ALTER DATABASE QuanLyBanGiay SET CHARACTER SET utf8mb4;
ALTER DATABASE QuanLyBanGiay SET COLLATE utf8mb4_unicode_ci;
...
(1019, 660, 2700),
(2, 100, 150);
-- Tạo ràng buộc khóa ngoại cho bảng Cart trỏ tới bảng Account
ALTER TABLE Cart ADD CONSTRAINT FK_Cart_Account FOREIGN KEY (accountID) REFERENCES Account (uID);

-- Tạo ràng buộc khóa ngoại cho bảng Cart trỏ tới bảng Product
ALTER TABLE Cart ADD CONSTRAINT FK_Cart_Product FOREIGN KEY (productID) REFERENCES Product (id);

-- Tạo ràng buộc khóa ngoại cho bảng Invoice trỏ tới bảng Account
ALTER TABLE Invoice ADD CONSTRAINT FK_Invoice_Account FOREIGN KEY (accountID) REFERENCES Account (uID);


-- Ràng buộc cho bảng Product trỏ tới bảng Account
ALTER TABLE Product ADD CONSTRAINT FK_Product_Account FOREIGN KEY (sell_ID) REFERENCES Account (uID);

-- Ràng buộc cho bảng Product trỏ tới bảng Category
ALTER TABLE Product ADD CONSTRAINT FK_Product_Category FOREIGN KEY (cateID) REFERENCES Category (cid);

-- Ràng buộc cho bảng Review trỏ tới bảng Account
ALTER TABLE Review ADD CONSTRAINT FK_Review_Account FOREIGN KEY (accountID) REFERENCES Account (uID);

-- Ràng buộc cho bảng Review trỏ tới bảng Product
ALTER TABLE Review ADD CONSTRAINT FK_Review_Product FOREIGN KEY (productID) REFERENCES Product (id);

-- Ràng buộc cho bảng SoLuongDaBan trỏ tới bảng Product
ALTER TABLE SoLuongDaBan ADD CONSTRAINT FK_SoLuongDaBan_Product FOREIGN KEY (productID) REFERENCES Product (id);

-- Ràng buộc cho bảng Supplier trỏ tới bảng Category
ALTER TABLE Supplier ADD CONSTRAINT FK_Supplier_Category FOREIGN KEY (cateID) REFERENCES Category (cid);

-- Ràng buộc cho bảng TongChiTieuBanHang trỏ tới bảng Account
ALTER TABLE TongChiTieuBanHang ADD CONSTRAINT FK_TongChiTieuBanHang_Account FOREIGN KEY (userID) REFERENCES Account (uID);
