...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
 ...
 <!-- Carousel wrapper -->
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:185px; margin: auto;" src="https://hagialuxury.com/wp-content/uploads/2019/05/icon_bank.png" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQB_fN9h0DcsgnkZPugyoKQGm4_peHUOKMJ3Q&usqp=CAU" alt="Card image cap">
    <div class="card-body">
